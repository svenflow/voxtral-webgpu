...
declare function runBenchmark(onProgress?: (msg: string) => void): Promise<BenchmarkReport>;
...
declare const defaultConfig: VoxtralConfig;
 ...
 */
declare function parseSafetensorsHeader(url: string): Promise<{
 ...
 */
declare function convertBF16toF16(bf16Bytes: ArrayBuffer): ArrayBuffer;
/**
 * Load weight manifest from a URL.
 */
declare function loadManifest(baseUrl: string): Promise<WeightManifest>;
 ...
 */
declare function loadTensorFromManifest(baseUrl: string, manifest: WeightManifest, tensorName: string): Promise<Float32Array | Uint16Array>;
/**
 * Load a tensor directly from safetensors, converting BF16→F16 on the fly.
 */
declare function loadTensorFromSafetensors(url: string, header: SafetensorsHeader, dataOffset: number, tensorName: string): Promise<Uint16Array>;
/**
...
declare function loadComponentWeights(device: GPUDevice, baseUrl: string, manifest: WeightManifest, component: string, onProgress?: (progress: WeightLoadProgress) => void): Promise<ComponentWeights>;
/**
 ...
 */
declare function loadWeightsFromHF(device: GPUDevice, safetensorsUrl?: string, onProgress?: (progress: HFLoadProgress) => void): Promise<{
 ...
 */
declare function parseNpy(buffer: ArrayBuffer): NpyArray;
/**
 * Load a .npy file from a URL.
 */
declare function loadNpy(url: string): Promise<NpyArray>;
/**
 * Compare two arrays with allclose semantics.
 * Returns { passed, maxAbsDiff, maxRelDiff, mismatchCount }
 */
declare function allclose(actual: Float32Array | Int32Array | Uint32Array, expected: Float32Array | Int32Array | Uint32Array, atol?: number, rtol?: number): {
    passed: boolean;
    maxAbsDiff: number;
    maxRelDiff: number;
